...
public class User {
    ...
    public User(String userName, String userFirstName, String userLastName, int userPhoneNo, String userNIC,
            Date userDOB, String userAddress, String userGender, String mariedState) {
